...
export class TradeDetails extends React.Component<TradeDetailsProps> {
  ...
  public render() {
    ...
    return (<section className={styles.details}> {
      price && <>
        <TradeData label="Liquidation Price (ETH/USD)"
        ...
        />
        <TradeData label="Collaterlization ratio"
                   ...
                   style={{ marginBottom: '2px' }}
        />
        <TradeData label="current price information (ETH/USD)"
        ...
        />
        <TradeData label="Minimum ratio"
                   data-test-id="trade-slippage-limit"
                   tooltip={slippageLimitTooltip}
                   value={
                     <FormatPercent value={new BigNumber(slippageLimit.times(50))}
                                    precision={2}
                     />
                   }
                   style={{ marginBottom: '2px' }}
        />
        <TradeData label="Liquidation penalty"
