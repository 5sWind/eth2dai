...
function error(msg: Message | undefined) {
  ...
  switch (msg.kind) {
    ...
    case MessageKind.dustAmount:
      return (
        <>
          The Minimum generation value is {msg.amount.valueOf()} {msg.token.toUpperCase()}
        </>
      );
    case MessageKind.incredibleAmount:
      return (
        <>
          The Maximum generation value is {msg.amount.valueOf()} {msg.token.toUpperCase()}
        </>
      );
...
export class NewTradeView extends React.Component<InstantFormState> {
  ...
  public render() {
    ...
    return (
      <InstantFormWrapper heading="Collateralize & Generate DAI"
                          btnLabel="Collateralize / Generate DAI"
